...
export default {
  ...
  mounted() {
    this.styleExampleList.forEach((it) => {
      it.checked = localStorage.getItem('THEME_STYLE') === it.themeId || this.state.theme === it.themeId
    })
    this.layoutExampleList.forEach((it) => {
      it.checked = localStorage.getItem('THEME_LAYOUT_STYLE') === it.layoutId || this.state.layoutMode === it.layoutId
    })
    this.primartyColorList.forEach((it) => {
      it.checked = localStorage.getItem('THEME_COLOR_STYLE') === 'theme_color_' + it.name || this.state.themeColor === 'theme_color_' + it.name
    })
  },
  methods: {
    show() {
    ...
    exampleClick(item) {
      ...
      localStorage.setItem('THEME_STYLE', this.state.theme)
    ...
    layoutExampleClick(item) {
      ...
      localStorage.setItem('THEME_LAYOUT_STYLE', item.layoutId)
    ...
    colorClick(item) {
      ...
      localStorage.setItem('THEME_COLOR_STYLE', 'theme_color_' + item.name)
