    ...
    [`data|${size}`]: [
      {
        ...
        'image': Random.image('300x600', '#50B347', '#FFF', 'Asiainfo Admin Mgmt'),
    ...
    [`data|${size}`]: [
      {
        ...
        'avatar': Random.image('100x100', '#50B347', '#FFF', 'Asiainfo Admin Mgmt'),
        'nickName': function () {
          return Random.cname()
        },
        content: function () {
        ...
        'images|0-1': [
          ...
          Random.image('300x600', '#697eff', '#FFF', 'Asiainfo Admin Mgmt'),
